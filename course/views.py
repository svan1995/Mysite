...
#         super(ManageLessonListView,self).__init__(*args,**kwargs)
#         self.course_id = course_id

#     def get_queryset(self):
#         qs = super(ManageLessonListView,self).get_queryset()
#         return qs.filter(course = Course.objects.filter(id = self.course_id))
