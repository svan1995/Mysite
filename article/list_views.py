...
def article_detail(request,id,slug):
    ...
    most_viewd = list(ArticlePost.objects.filter(id__in = article_ranking_ids))
    most_viewd.sort(key = lambda x: article_ranking_ids.index(x.id))
    ...
    return render(request,"article/list/article_detail.html",{"article":article
        ,"total_views":total_views,"most_viewd":most_viewd,"comment_form":comment_form,
